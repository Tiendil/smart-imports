...
class TestAnalyzer(unittest.TestCase):
    ...
    @unittest.skipUnless(sys.version.startswith('3.8'), 'test only for python 3.8')
    def test_python_3_8(self):

        with open(os.path.join(TEST_FIXTURES_DIR, 'python_3_8', 'full_parser_test.py')) as f:
            code = f.read()
    ...
    @unittest.skipUnless(sys.version.startswith('3.9'), 'test only for python 3.9')
    def test_python_3_9(self):

        with open(os.path.join(TEST_FIXTURES_DIR, 'python_3_9', 'full_parser_test.py')) as f:
            code = f.read()
    ...
    @unittest.skipUnless(sys.version.startswith('3.10'), 'test only for python 3.10')
    def test_python_3_10(self):

        with open(os.path.join(TEST_FIXTURES_DIR, 'python_3_10', 'full_parser_test.py')) as f:
            code = f.read()
